...
public class LinkDataFormActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_link_data_form);
    ...
    private void getLinkDataForm() {
        ...
        Call<List<LinkDataForm>> call = apiService.getLinkDataForm(link);
